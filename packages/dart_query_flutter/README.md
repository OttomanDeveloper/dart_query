...
[![pub package](https://img.shields.io/pub/v/dart_query_flutter.svg)](https://pub.dev/packages/dart_query_flutter)
[![License: MIT](https://img.shields.io/badge/license-MIT-blue.svg)](https://opensource.org/licenses/MIT)
[![Flutter 3](https://img.shields.io/badge/Flutter-3.0+-02569B.svg)](https://flutter.dev)

**Flutter adapter for [dart_query](https://pub.dev/packages/dart_query).** Drop-in widget builders that replace your `FutureBuilder` + loading + error + retry boilerplate with one widget.
...
```dart
// Without dart_query_flutter -- repeated on every screen
...
This package re-exports `dart_query`, so you only need this one import:
...
See [`dart_query_devtools`](https://pub.dev/packages/dart_query_devtools) for details.
