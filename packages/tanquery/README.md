...
[![pub package](https://img.shields.io/pub/v/tanquery.svg)](https://pub.dev/packages/tanquery)
...
> **Flutter users:** You probably want [`tanquery_flutter`](https://pub.dev/packages/tanquery_flutter) instead, which includes widget builders like `QueryBuilder`. This package is the pure Dart core.
...
- [`tanquery_flutter`](https://pub.dev/packages/tanquery_flutter) -- Widget builders
- [`tanquery_devtools`](https://pub.dev/packages/tanquery_devtools) -- Visual cache inspector
